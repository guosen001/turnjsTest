...
var has3d,
  ...
  turnMethods = {
    ...
    init: function (options) {
      ...
      // this.turn('destroy') // destroy the old instance
      ...
      if (element)
        if (turnMethods._necessPage.call(this, page)) {
          if (!data.pageWrap[page]) {
            ...
            element.css({ width: prop.width, height: prop.height }).attr('data-line', 273);
    ...
    center: function (page) {
      ...
      if (!data.noCenter) {
        ...
        $(this).css({ marginLeft: left }).attr('data-line', 316);
      }
    ...
    destroy: function () {
      ...
      console.log('destriy-->', data, 'destroying' in data, 'fparent' in data);
      // 如果已经绑定事件，则解绑
      ...
      if (page === undefined) {
        ...
        if (!data.disabled && !data.destroying) {
          ...
          if (page > 0 && page <= data.totalPages) {
            ...
            throw turnError("The page " + page + " does not exist 1166");
          }
        }
      }
    },
